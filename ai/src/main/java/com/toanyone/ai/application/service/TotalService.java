...
public class TotalService {
    ...
    public void sendMessageToAiAndSlack(RequestCreateMessageDto requestCreateMessageDto, HttpServletRequest request) {
        ...
        Ai ai = aiService.save(question, answer, request);

        slackService.save(ai, question + "\n" + answer, OrderStatus.SUCCESS, request);
    }
}
