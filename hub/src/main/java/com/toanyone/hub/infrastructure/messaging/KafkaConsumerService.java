...
public class KafkaConsumerService {
    ...
    public void consumeHubCreateSuccessMessage(HubCreateMessage hubCreateMessage) {
        ...
        slackClient.sendSlackMessage(new RequestCreateMessageDto("xxxx", "허브 생성에 성공했습니다."));
    }
    ...
    public void consumeHubCreateFailureMessage(HubCreateMessage hubCreateMessage) {
        ...
        slackClient.sendSlackMessage(new RequestCreateMessageDto("xxxx", "허브 생성에 실패했습니다. 다시 시도해 주세요."));
